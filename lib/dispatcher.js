...
var dispatcher = function() {
  return {
    ...
    /**
     * Writes the short URL to a TeX file to be included in the compiled cover letter.
     * @param {Object} options
     * @param (string} options.output_file - TeX file to write the URL to
     * @param {string} options.url - The URL to write
     * @returns {Function} Promise
     */
    writeUrlTex: function writeUrlTex(options) {
